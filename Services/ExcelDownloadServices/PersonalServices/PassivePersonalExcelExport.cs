...
public class PassivePersonalExcelExport
{
    public byte[] ExportToExcel(List<PassivePersonalDto> personals)
    {
        ...
        using (ExcelPackage package = new ExcelPackage(excelFile))
        {
            ...
            worksheet.Cells[1, 8].Value = "Emeklilik Durumu";
            ...
            worksheet.Cells[1, 12].Value = "Personel SQL ID";
            ...
            foreach (var entity in personals)
            {
                ...
                worksheet.Cells[row, 7].Value = entity.EndJobDate.ToString();
                ...
                worksheet.Cells[row, 12].Value = entity.ID.ToString();
